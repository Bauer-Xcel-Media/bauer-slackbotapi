...
slackAPI.prototype.sendMsgWithAttachment = function (channel, text, attachments) {
    var data = {token: token, 'type': 'message', 'channel': channel, 'text': text, 'attachments': JSON.stringify(attachments), 'username': botUsername};
    reqAPI('chat.postMessage', data, function (result) {
